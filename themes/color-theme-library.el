  ...
  (color-theme-install
   '(color-theme-hober
     ((foreground-color . "#c0c0c0")
      ...
      (background-mode . dark))
     (default ((t (nil))))
     (modeline ((t (:foreground "black" :background "gainsboro"))))
     (modeline-buffer-id ((t (:foreground "red" :background "gainsboro" :weight bold))))
...
(defun color-theme-vibrant-ink ()
  ...
  (color-theme-install
   '(color-theme-vibrant-ink
     ...
     (italic ((t (:italic t))))
     (modeline ((t (:background "#444444" :foreground "white"))))
